...
end, { desc = "Find next diagnostic", noremap = true, silent = true })
map("n", "<leader>f]", function()
    vim.cmd.RustLsp { "renderDiagnostic", "cycle_prev" }
end, { desc = "Find prev diagnostic", noremap = true, silent = true })
...
map("n", "<Leader>gh", function()
    vim.lsp.buf.hover()
end, { silent = true, desc = "Hover actions" })
map("n", "<Leader>gx", function()
    vim.cmd.RustLsp { "relatedDiagnostics" }
end, { silent = true, desc = "Related diagnostics" })
map(
    "n",
    "<Leader>gd",
...
map("n", "<leader>tn", "<cmd>TestNearest<CR>", { desc = "Test Nearer to cursor" })
map("n", "<leader>tl", "<cmd>TestLast<CR>", { desc = "Test Last" })
map("n", "<leader>tv", "<cmd>TestVisit<CR>", { desc = "Test Visit" })

-- CopilotChat
map("n", "<leader>ct", "<cmd>CopilotChatToggle<CR>", { desc = "Toggle Copilot Chat", noremap = true, silent = true })
